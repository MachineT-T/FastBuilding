...
public class EventListener{
    ...
    public static void registerEvent(string type,System.Action<object> callback)
    {
        lock (instance)
        {
    ...
    public static int deleteEvent(string type, System.Action<object> callback)
    {
        lock (instance)
        {
    ...
    public static void dispatchEvent(string type,object data)
    {
        lock (instance)
        {
            if (instance.map.Contains(type))
            {
                ...
                {
                    System.Action<object> callback = (System.Action<object>)array[i];
                    callback(data);
