...
public class TestForm2 : UIWindows
{
    ...
    protected override UIType m_uiFormType
    {
        get
        {
            if (_uiFormType == null)
            {
                ...
                _uiFormType.UIForms_Type = UIFormType.PopUp;
                _uiFormType.UIForm_LucencyType = UIFormLucenyType.Translucence;
            }
            return _uiFormType;
        }
    }
    ...
    protected override void OnInit()
    {
        ...
        {
            Frame.View.UIManager.Instance.ShowUIForm("TestForm3");
        });
    }
